...
function Tween(p6, p7, p8)
    local easingStyle = Enum.EasingStyle[p7[2]]
    local easingDirection = Enum.EasingDirection[p7[3]]
    ...
    local tweenInfo = TweenInfo.new(p7[1], easingStyle, easingDirection)
    local tween = vu4.TweenService:Create(p6, tweenInfo, p8)
    tween:Play()
...
function Ripple(pu9)
    spawn(function()
        ...
        v10.ZIndex = 8
        v10.Image = 'rbxassetid://95828101007163'
...
function vu1.new(pu27, p28, p29)
    ...
    v50.ZIndex = -1
    v50.Image = 'rbxassetid://95828101007163'
    ...
    v59.Image = 'rbxassetid://95828101007163'
    ...
    local gradientTween = tweenService:Create(v52, TweenInfo.new(7, Enum.EasingStyle.Linear, Enum.EasingDirection.In, -1), {
        Rotation = 360
    })
    gradientTween:Play()
    ...
    coroutine.wrap(function()
        ...
        local vu62 = tweenService:Create(vu61, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {
    ...
    vu47.Active = true
    vu47.Draggable = true
    vu47.Image = 'rbxassetid://95828101007163'

    vu47.MouseButton1Click:Connect(function()
        vu36.Visible = not vu36.Visible
        vu47.Image = vu36.Visible and 'rbxassetid://95828101007163' or 'rbxassetid://95828101007163'
    end)
    ...
    return {
        Tab = function(_, p74, p75)
            ...
            local v81 = 'rbxassetid://95828101007163'
            ...
            return {
                section = function(_, p84, p85)
                    ...
                    vu89.Image = 'rbxassetid://95828101007163'
                    vu89.ImageTransparency = 0
                    ...
                    vu90.Image = 'rbxassetid://95828101007163'
                    ...
                    local vu94 = p85 or false

                    if p85 ~= false then
                        local newSize = vu94 and (36 + vu93.AbsoluteContentSize.Y + 8) or 36
                        vu86.Size = UDim2.new(0.981000006, 0, 0, newSize)
                    ...
                    return {
                        Button = function(_, p95, p96)
                            local vu97 = p96 or function() end
                        ...
                        Toggle = function(_, p105, pu106, p107, p108)
                            ...
                            local vu119 = {
                                SetState = function(_, p118)
                                    if p118 == nil then
                                        p118 = not vu1.flags[pu106]
                                    end
                                    if vu1.flags[pu106] ~= p118 then
                                        local targetPosition = p118 and UDim2.new(0, vu115.Size.X.Offset / 2, 0, 0) or UDim2.new(0, 0, 0, 0)
                                        local targetColor = p118 and Color3.fromRGB(135, 206, 235) or beijingColor
                        ...
                        Keybind = function(_, p120, pu121, p122)
                            local vu123 = p122 or function() end
                            ...
                            local vu126 = not pu121 or vu125[tostring(pu121)] or (pu121.Name or 'None')
                            ...
                            vu130:GetPropertyChangedSignal('TextBounds'):Connect(function()
                        ...
                        Textbox = function(_, p139, pu140, pu141, p142)
                            ...
                            vu149.FocusLost:Connect(function()
                                ...
                                vu1.flags[pu140] = vu149.Text

                                vu143(vu149.Text)
                            end)

                            vu149:GetPropertyChangedSignal('TextBounds'):Connect(function()
                        ...
                        Slider = function(_, p153, pu154, p155, p156, p157, p158, p159)
                            ...
                            local vu181 = {
                                SetValue = function(_, p177)
                                    ...
                                    if p177 then
                                        ...
                                        v178 = (vu5.X - vu168.AbsolutePosition.X) / vu168.AbsoluteSize.X
                                    end
                            ...
                            vu174:GetPropertyChangedSignal('Text'):Connect(function()
                                if vu186 then
                        ...
                        Dropdown = function(_, p196, pu197, p198, p199)
                            local vu200 = p199 or function() end
                            ...
                            vu205:GetPropertyChangedSignal('Text'):Connect(function()
                                if vu216 then
                                    vu215(vu205.Text)
                                end
                            end)

                            vu206:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
                                if vu216 then
